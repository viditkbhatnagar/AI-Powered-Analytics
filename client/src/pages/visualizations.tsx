...
const prebuiltCharts: PrebuiltChart[] = [
  { id: "1", name: "Initiatives Timeline", description: "Gantt-style timeline of government and industry initiatives with timeframes and KPI targets.", category: "trends", chartType: "gantt", library: "echarts", dataSource: "initiatives" },
  ...
  { id: "3", name: "Regional Distribution", description: "Donut chart of initiatives grouped by region or scope.", category: "trends", chartType: "pie", library: "echarts", dataSource: "initiatives" },
  { id: "4", name: "Sector Impact Analysis", description: "Sankey diagram flowing initiatives to the domains they impact.", category: "trends", chartType: "sankey", library: "echarts", dataSource: "initiatives" },
  ...
  { id: "9", name: "Domain Hierarchy", description: "Treemap of domains sized by role count with nested sub-domains.", category: "domains", chartType: "treemap", library: "echarts", dataSource: "domains" },
  ...
  { id: "17", name: "Salary Range by Domain", description: "Box plot showing salary distribution per domain (min, Q1, median, Q3, max) in the active industry's currency.", category: "salary", chartType: "boxplot", library: "echarts", dataSource: "salaries" },
  ...
  { id: "20", name: "Salary Distribution", description: "Histogram of all salary values showing frequency distribution.", category: "salary", chartType: "histogram", library: "echarts", dataSource: "salaries" },
