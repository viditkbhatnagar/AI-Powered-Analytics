...
const prebuiltCharts: PrebuiltChart[] = [
  { id: "1", name: "Initiatives Timeline", description: "Gantt-style timeline of government and industry initiatives. Scopes, timeframes and KPI targets are colour-coded by region of the active industry.", category: "trends", chartType: "gantt", library: "echarts", dataSource: "initiatives" },
  ...
  { id: "3", name: "Regional Distribution", description: "Donut chart of initiatives grouped by region or scope. Hover for the breakdown.", category: "trends", chartType: "pie", library: "echarts", dataSource: "initiatives" },
